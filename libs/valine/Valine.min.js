 ...
 * Last Update: 2020/4/26 上午9:27:35
 */
! function (e, t) {
	...
	return function (e) {
		...
		t.DEFAULT_EMOJI_CDN = "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/", t.DB_NAME = "Comment", t.defaultConfig = {
			...
			enableQQ: !1,
			requiredFields: []
		}, t.defaultMeta = ["nick", "mail", "link"], t.QQCacheKey = "_v_Cache_Q", t.MetaCacheKey = "_v_Cache_Meta", t.RandomStr = (Date.now() + Math.round(1e3 * Math.random())).toString(32), t.VERSION = "1.4.11"
	}, function (e, t, n) {
		function r(e, t) {
		...
		*/
			...
			I = {
				...
				show: function (e, t) {
					...
					if (t.forEach(function (e) {
							...
							t && t.text("0"), n.push(decodeURI((0, y.default)(e).attr("id")))
						}), n.length) {
							...
							e.length > 0 && t.forEach(function (t) {
								e.forEach(function (e) {
									var n = e.get("xid") || encodeURI(e.get("url")),
										r = e.get("time"),
										o = (0, y.default)(t);
									if (encodeURI(o.attr("id")) == n || encodeURI(o.attr("data-xid")) == n) {
										var i = o.find(".leancloud-visitors-count");
										i && i.text(r)
									}
								})
							})
		...
		o.prototype.Q = function (e) {
			...
			z.on("click", F), (0, y.default)(document).on("keydown", function (e) {
				e = event || e;
				var t = e.keyCode || e.which || e.charCode;
				((e.ctrlKey || e.metaKey) && 13 === t && F(), 9 === t) && ("veditor" == (document.activeElement.id || "") && (e.preventDefault(), x(i[0], "    ")))
			}).on("paste", function (e) {
		...
		t.__esModule = !0, t.default = function (e, t) {
			if (e.$el && e.$loading.hide().$nodata.hide(), "[object Error]" === {}.toString.call(ex)) {
				var n = ex.code || ex.message || ex.error || "";
				if (isNaN(n)) e.$el && e.$nodata.show('<pre style="text-align:left;"> ' + JSON.stringify(ex) + "</pre>");
				else {
					var r = e.i18n.t("code-" + n),
						o = (r == "code-" + n ? void 0 : r) || ex.message || ex.error || "";
					101 == n || -1 == n ? e.$nodata.show() : e.$el && e.$nodata.show('<pre style="text-align:left;">Code ' + n + ": " + o + "</pre>")
				}
			} else e.$el && e.$nodata.show('<pre style="text-align:left;">' + JSON.stringify(ex) + "</pre>")
		}
	}, function (e, t, n) {
		"use strict";
		...
		var i = function (e, t, n, r) {
			return n = String(n), "style" === t ? t + '="' + (/^color/gi.test(n) ? n : "").replace(/(color:[#0-9a-fA-F]{1,6};?).+/gi, "$1") + '"' : "img" === e ? t + '="' + o.default.escapeAttrValue(n) + '" referrerPolicy="no-referrer" ' : void 0
		}
	}, function (e, t, n) {
		var r;
		! function (o) {
